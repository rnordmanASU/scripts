...
`,zr=L(((e,n)=>i("div",{class:(0,ie.cx)("universal-nav",e.open?"mobile-open":"",e.searchOpen?"search-open":""),ref:n,children:i("div",{children:e.children})}))),Sr=({children:e,...n})=>i("div",{class:(0,ie.cx)("nav-grid",n.class),children:e}),Cr=ie.css`
  font-weight: 700;
  text-align: left;
  opacity: 1;
  margin: 1rem 0;
