...
`,$e="1224px",Ce="24px",Pe=j((({disabled:e,small:n,medium:t,large:r,gold:o,maroon:a,dark:s,type:c,...l},f)=>{const d="link"==c?"a":"button";let u=!!l.light&&l.light;return void 0===o&&void 0===s&&void 0===a&&(u=!0),i(d,{...l,class:(0,ie.cx)(ie.css`
...
`,xr=e=>i("div",{class:(0,ie.cx)("navbar-container",e.class),children:e.children}),kr=({children:e,breakpoint:n,...t})=>i(r.Fragment,{children:[i("div",{id:"asu-report-accessiblity",children:i("a",{href:"https://www.asu.edu/accessibility/",class:ie.css`
          ...
          `,yr(n),rr(n),Te,wr(n),lr(n),Or(n),or(n),dr(n),sr(n),br(n),pr(n)),children:e})]}),Or=e=>ie.css`
  .universal-nav {
    padding: 0 2rem;
    display: flex;
    justify-content: center;
...
`,zr=j(((e,n)=>i("div",{class:(0,ie.cx)("universal-nav",e.open?"mobile-open":"",e.searchOpen?"search-open":""),ref:n,children:i("div",{children:e.children})}))),Sr=({children:e,...n})=>i("div",{class:(0,ie.cx)("nav-grid",n.class),children:e}),$r=ie.css`
  font-weight: 700;
  text-align: left;
  opacity: 1;
  margin: 1rem 0;
